...
import { projects } from '../data/portfolioData'; // <--- Now importing projects

const StackCard = ({ index, project, progress, totalCards }) => {
  const range = [index * (1 / totalCards), 1];
  
  // Scale and rotate the cards, but keep opacity strictly at 1
    ...
    <div className="h-screen sticky top-0 flex items-center justify-center p-4">
      <motion.div
        style={{
          scale, 
          rotate, 
          opacity: 1, // Explicitly locked to 1
        ...
        <div className="flex flex-col xl:flex-row justify-between items-stretch gap-8 xl:gap-12 h-full min-h-[400px]">
          ...
          <div className="flex-1 flex flex-col justify-between">
            <div>
              ...
              {/* Changed from 'role' to 'category' to fit projects better */}
          ...
          {project.image && (
            <div className="w-full xl:w-[40%] h-[300px] xl:h-auto min-h-[350px] relative rounded-[2rem] overflow-hidden border border-neutral-800 shrink-0">
              <img 
                src={project.image} 
                alt={project.title} 
          ...
          {/* Actions Column (Live Demo & GitHub Code) */}
          <div className="flex gap-4 xl:flex-col shrink-0 items-start xl:items-end justify-start">
            <a 
              href={project.liveLink || "#"}
              target="_blank"
              rel="noreferrer"
              className="w-14 h-14 rounded-full border border-neutral-700 flex items-center justify-center text-white hover:bg-[#C6F118] hover:text-black hover:border-[#C6F118] transition-colors group z-10"
            ...
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="w-14 h-14 rounded-full border border-neutral-700 flex items-center justify-center text-white hover:bg-white hover:text-black hover:border-white transition-colors group z-10"
...
export default function ScrollStack() {
  ...
  return (
    <div className="w-full bg-[#050505] relative z-20" id="projects">
      <div className="max-w-[94vw] mx-auto px-4 md:px-8 pt-32 pb-12">
